       ...
       <?php 
        ...
        <form action="posts_edit_action.php" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="" value="<?= $posts['title']?>" name="title">
            </div>
            <div class="form-group">
                <label for="">Description</label>
                <input type="text" value="<?= $posts['description']?>" class="form-control" id="" placeholder="" name="description">
            </div>
            <div class="form-group">
                <label for="">Contents</label>
                <textarea class="form-control" id="" placeholder="" name="contents" rows="8" value="" ><?= $posts['contents']?></textarea>

            </div>
            <div class="form-group">
                <label for="">Thumbnail</label>
                <img src="../../img/<?= $posts['thumbnail']?>">
            ...
            <div class="form-group">
                ...
                <input <?= ($posts['status']== 1)?'checked':''?> type="checkbox" id=""value="1" name="status" placeholder=""><em>(Check để hiển thị bài viết)</em>
            </div>
