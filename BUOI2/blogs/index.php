...
//câu lệnh truy vấn
$query_recent_post="SELECT * FROM `posts`ORDER BY created_ad DESC limit 6 ";
			...
			<div class="container">
				...
				<div class="row">
                   ...
                   foreach ($recent_posts as $recent_post ) {
					...
					<div class="col-md-4">
						<div class="post">
							<a class="post-img" href="blog-post.html"><img src="<?php echo $recent_post['thumbnail']; ?> " alt="" with='400px' height='300px'/></a>
							<div class="post-body">
								<div class="post-meta">
									<a class="post-category cat-1" href="category.html">Web Design</a>
									<span class="post-date"><?php echo $recent_post['created_ad']; ?></span>
								</div>
				...
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							<?php
                   foreach ($_posts1 as $_post1 ) {
	                     //print_r($post);
                     ?>
							<!-- post -->
							<div class="col-md-12">
								<div class="post post-thumb">
									<a class="post-img" href="blog-post.html"><img src="<?php echo $_post1['thumbnail']?>" alt=""></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-3" href="category.html">Jquery</a>
											<span class="post-date"><?php echo $_post1['created_ad']?></span>
										</div>
										<h3 class="post-title"><a href="blog-post.html"><?php echo $_post1['title']?></a></h3>
									</div>
								</div>
							</div>
							<!-- /post -->
